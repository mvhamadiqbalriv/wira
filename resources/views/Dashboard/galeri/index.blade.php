...
<div class="main-panel">
    ...
    <h1 class="h2">Tambahkan Galeri</h1>
  </div><div class="table-responsive col-lg-8 justify-content-center align-items-center">
    <a class="btn btn-info mb-3" href="/dashboard/galeri/create">Tambahkan Foto Baru</a>
            ...
            <tbody>
                <div class="d-flex align-items-center">
                    ...
                    <tr>
                        ...
                        <td><img src="{{ Storage::url($galeri->foto) }}" class="img-fluid" style="max-width: 150px"></td>
